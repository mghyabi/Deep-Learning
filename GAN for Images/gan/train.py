...
def train(D, G, D_solver, G_solver, discriminator_loss, generator_loss, show_every=250, 
    ...
    for epoch in range(num_epochs):
        ...
        for x, _ in train_loader:
            ...
            logits_fake = D(fake_images.view(batch_size, 3, 128, 128)) #P2
#             logits_fake = D(fake_images.view(batch_size, 3, 64, 64)) #celeba
#             logits_fake = D(fake_images.view(batch_size, 1, 28, 28)) #MNIST
            ...
            gen_logits_fake = D(fake_images.view(batch_size, 3, 128, 128)) #P2
#             gen_logits_fake = D(fake_images.view(batch_size, 3, 64, 64)) #celeba
#             gen_logits_fake = D(fake_images.view(batch_size, 1, 28, 28)) #MNIST
